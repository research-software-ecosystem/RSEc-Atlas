...
PAGE_DATA_KEY_MAPPINGS = {
    ...
    "galaxy": {
        ...
        "tool_ids": ("Tool_IDs",),
        "no_of_tools": {
            "usegalaxy.eu": ("Number_of_tools_on_UseGalaxy.eu",),
            "usegalaxy.org": ("Number_of_tools_on_UseGalaxy.org_(Main)",),
            "usegalaxy.org.au": ("Number_of_tools_on_UseGalaxy.org.au",),
            "usegalaxy.be": ("Number_of_tools_on_UseGalaxy.be",),
            "usegalaxy.cz": ("Number_of_tools_on_UseGalaxy.cz",),
            "usegalaxy.fr": ("Number_of_tools_on_UseGalaxy.fr",),
            "usegalaxy.no": ("Number_of_tools_on_UseGalaxy.no",),
        },
    },
}
